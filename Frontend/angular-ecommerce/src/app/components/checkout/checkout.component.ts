...
export class CheckoutComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        // const startMonth: number = new Date().getMonth() + 1; // its 0 based
    ...
    get billingAddressState2() {return this.checkoutFormGroup.get('billingAddress.state');}
    ...
    copyShippingAddressToBillingAddress(event: Event) {
        const copyBilling = (event.target as HTMLInputElement).checked;
    ...
    handleMonthsAndYears() {
        ...
        if (currentYear === selectedYear) {
            startMonth = new Date().getMonth() + 1; // to get the actual month
        } else {
            startMonth = 1;
        }
    ...
    private setupStripePaymentForm() {
        ...
        this.cardElement.on('change', (event: any) => {
            ...
            if (event.complese) {
                ...
                // show the validation error to customer
